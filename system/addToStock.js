$(document).ready(function() {
    ...
    $('#addToStockAndSelect').on('shown.bs.modal', function(event) {
        let table = $("#selectProductA2S").DataTable().columns.adjust().draw();
        //focus search
        $("#selectProductTable_filter input").focus();

        $('#selectProductTable_filter input').on('keyup', function(e) {
